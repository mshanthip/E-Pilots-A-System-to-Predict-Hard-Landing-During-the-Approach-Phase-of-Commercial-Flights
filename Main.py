...
def graph():
    ...
    plt.show()
bg_image = Image.open("C:/Users/madan/OneDrive/Pictures/major.jpg")
bg_image = bg_image.resize((1500, 998), Image.BICUBIC)
...
title.config(fg='black', font=font)
title.pack(pady=50)
...
uploadButton = Button(main, text="Upload Flight Landing Dataset", command=uploadDataset, bg='white',fg='black')
uploadButton.place(x=50,y=150)
uploadButton.config(font=font1)

preprocessButton = Button(main, text="Preprocess Dataset", command=preprocessDataset, bg='white')
preprocessButton.place(x=50,y=200)
preprocessButton.config(font=font1)

svmButton = Button(main,text="Run SVM Algorithm", command=runSVM, bg='white')
svmButton.place(x=50,y=250)
svmButton.config(font=font1)

lrButton = Button(main,text="Run Logistic Regression Algorithm", command=runLR, bg='white')
lrButton.place(x=50,y=300)
lrButton.config(font=font1)

tdButton = Button(main,text="Run AP2TD Algorithm", command=runAP2TD, bg='white')
tdButton.place(x=50,y=350)
tdButton.config(font=font1)

apButton = Button(main,text="Run AP2DH Algorithm", command=runAP2DH, bg='white')
apButton.place(x=50,y=400)
apButton.config(font=font1)

dhButton = Button(main,text="Run DH2TD Algorithm", command=runDH2TD, bg='white')
dhButton.place(x=50,y=450)
dhButton.config(font=font1)

graphButton = Button(main,text="Comparison Graph", command=graph, bg='white')
graphButton.place(x=50,y=500)
graphButton.config(font=font1)

closeButton = Button(main,text="Exit", command=close, bg='white')
closeButton.place(x=50,y=550)
